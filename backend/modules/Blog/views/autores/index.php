  ...
  <div class="col-lg-12">
    <section class="panel ml10 mr10">
      <header class="panel-heading">
        <?= Html::a('<i class="fa fa-plus mr5"></i>Crear Autor', ['create'], ['class' => 'btn bg-success btn-xs']) ?>
      </header>
        ...
        'columns' => [
          ...
          [
              ...
              'value' => function ($model) {
                  $check = ($model->status == Authors::STATUS_ACTIVE) ? "checked='checked'" : null;
...
<?php
$this->registerJs('listenerChangeStatus("'.Url::to(["//Blog/autores/status"]).'");');
?>
